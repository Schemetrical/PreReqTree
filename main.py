...
'''input = Either (a) all of CPSC 213, CPSC 221 or (b) all of CPSC 210, CPSC 213, CPSC 260, EECE 320.
CPSC 310.
One of CPSC 103, CPSC 110, CPSC 260, EOSC 211, PHYS 210 and one of MATH 101, MATH 103, MATH 105, MATH 121 and one of MATH 152, MATH 221, MATH 223.
One of CPSC 210, EECE 210, CPEN 221 and one of CPSC 121, MATH 220.
(Principles of Mathematics 12 or Pre-calculus 12.)
One of CPSC 110, CPSC 260.
One of CPSC 103, CPSC 110, CPSC 260, EOSC 211, PHYS 210 and one of MATH 101, MATH 103, MATH 105, MATH 121 and one of MATH 152, MATH 221, MATH 223.
One of CPSC 210, EECE 210, EECE 309, CPEN 221.
APSC 160.
Either (a) CPSC 221 or (b) all of CPSC 260, EECE 320 and one of CPSC 210, EECE 210, EECE 309.
One of EECE 259, CPEN 211 and one of CPSC 260, EECE 210, CPEN 221.
...
CPSC 210.
Either (a) CPSC 221 or (b) all of CPSC 260, EECE 320. (In addition to above pre-requisites, at least 3 credits from COMM 291, BIOL 300, MATH or STAT at 200 level or above.)
CPSC 210.
All of CPSC 213, CPSC 221.
All of CPSC 121, CPSC 210.
One of MATH 200, MATH 217, MATH 226, MATH 253 and one of MATH 152, MATH 221, MATH 223 and either (a) CPSC 221 or (b) all of CPSC 260, EECE 320.
All of CPSC 310, CPSC 344 and one of STAT 200, STAT 241.
CPSC 320. (and six credits of BIOL beyond BIOL 111.)
CPSC 320.
All of CPSC 213, CPSC 221, CPSC 311.
Either (a) CPSC 221 or (b) all of CPSC 260, EECE 320. (CPSC 320 is recommended.)
CPSC 349.
One of CPSC 261, CPSC 313, EECE 476, CPEN 411 and one of CPSC 320, EECE 320.
Either (a) CPSC 310 or (b) one of EECE 310, CPEN 321 and one of EECE 315, CPEN 331.
One of CPSC 302, CPSC 303, MATH 307.
One of CPSC 313, EECE 315, CPEN 331.
(Third-year standing in a Computer Science or Computer Engineering specialization, and permission of the department.)
CPSC 320 and one of MATH 152, MATH 221, MATH 223 and one of MATH 200, MATH 217, MATH 226, MATH 253.
CPSC 322.
One of CPSC 313, EECE 315, CPEN 331 and one of CPSC 317, EECE 358, ELEC 331.
...
input = {'CPSC 313': 'Either (a) all of CPSC 213, CPSC 221 or (b) all of CPSC 210, CPSC 213, CPSC 260, EECE 320.',
'CPSC 319':'CPSC 310.',
...
grapher = Grapher()
grapher.plot_graph("CPSC 340", parsed_tree)
grapher.graph.render(filename='img/g1')
